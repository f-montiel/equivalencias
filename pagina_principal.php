...
<body>
	...
	<div class="container">
	<?php if (isset($printconfirmation)) {
		echo "<div class='alert alert-success' role='alert'>
  		<a class='alert-link'>" . $printconfirmation .  "</a></div>"; 
  		}
  	?>
	<?php if (isset($printerror)) {
		echo "<div class='alert alert-danger' role='alert'>
  		<a class='alert-link'>" . $printerror .  "</a></div>"; 
  		}
  	?>
		...
		<div class="list-group">
			<?php
				foreach ($tipos_um as $consulta) {
					...
					echo "<div class= 'pull-right'><a href=" . "calculo.php" . "?nombre=" . $consulta['nombre'] . "&" . "idTiposUm=" . $consulta['idtipos_um'] . "> Calcular </a>"; 
